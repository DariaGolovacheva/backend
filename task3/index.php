...
if (empty($_POST['name'])) {
    ...
    print('Имя не должно превышать 150 символов.<br/>');
    $errors = TRUE;
}
...
if (empty($_POST['phone'])) {
    ...
    print('Телефон не должен превышать 11 символов.<br/>');
    $errors = TRUE;
}
...
if (empty($_POST['email'])) {
    ...
    print('Адрес электронной почты не должен превышать 150 символов.<br/>');
    $errors = TRUE;
}
...
if (empty($_POST['biography'])) {
    ...
    $errors = TRUE;
} elseif (strlen($_POST['biography']) > 300) {
    print('Биография не должна превышать 300 символов.<br/>');
    $errors = TRUE;
}

if (empty($_POST['contract'])) {
    print('С контрактом ознакомлен (а).<br/>');
    $errors = TRUE;
}
